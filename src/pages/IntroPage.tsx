  ...
  return (
    <div style={{
        ...
        <div className="intro-login-column" style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              Don't have an account? <a href="#" onClick={(e) => { e.preventDefault(); setIsSignupModalOpen(true); setIsLogoGlowing(true); }} style={{
                color: '#0095f6',
                textDecoration: 'none',
                fontWeight: 'bold',
              }}>Sign up</a>
      ...
      <footer style={{
        ...
        <nav>
          <ul style={{
            ...
            <li><a href="#" style={{ color: '#8e8e8e', textDecoration: 'none' }}>About</a></li>
            <li><a href="#" style={{ color: '#8e8e8e', textDecoration: 'none' }}>Privacy</a></li>
            <li><a href="#" style={{ color: '#8e8e8e', textDecoration: 'none' }}>Terms</a></li>
          </ul>
        </nav>
      ...
      <SignupModal 
        ...
        onClose={() => { setIsSignupModalOpen(false); setIsLogoGlowing(false); }} 
        onConfirm={() => { setIsSignupModalOpen(false); setIsLogoGlowing(false); }}
      />
